...
function setupTypeButtons() {
    createCategoryButtons("type", "typeGroup", (id) => {
        typeId = id;
...
function setupDestinationButtons() {
    createCategoryButtons("destination", "destinationGroup", (id) => {
        destinationId = id;
        render();
    });
}
...
function setupInformationButtons() {
    createCategoryButtons("information", "informationGroup", (id) => {
        informationId = id;
        render();
    });
}
...
function setupInformation2Buttons() {
    createCategoryButtons("information2", "information2Group", (id) => {
        information2Id = id;
        render();
    });
}
...
function setupNextButtons() {
    createCategoryButtons("next", "nextGroup", (id) => {
        nextId = id;
        render();
    });
}
...
function setupCarNumberButtons() {
    createCategoryButtons("carNumber", "carNumberGroup", (id) => {
        carNumberId = id;
        render();
    });
}
